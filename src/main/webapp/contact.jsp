...
<html lang="en">
            ...
            <div class="contact-form-div">
              ...
              <div class="control-group confirm-div" style="display:none;">
                <div class="controls">
                  ...
                  <span class="send-msg-loading" style="display: none;"><img src="/img/spinner.gif" /></span>
  ...
  <script type="text/javascript">
    ...
    function loadMapScript() {
      ...
      script.type = "text/javascript";
      script.src = "http://maps.googleapis.com/maps/api/js?key=AIzaSyB9vvydIzphe3bTZCEpD55xAMdjMKZQcA4&sensor=false&callback=initializeMap";
      document.body.appendChild(script);
    }
    
    function showCaptcha(){
      Recaptcha.create("6LeEMekSAAAAAI2XDBH2V_CNkSB6LWlwXKa2kkap", "recaptcha_widget", {
                      theme : 'custom',
